...
# 20-configure/configure-system.sh
# System configuration: User, Network, Hostname
...
echo "System is configured. You may need to reboot for hostname changes to fully apply."
